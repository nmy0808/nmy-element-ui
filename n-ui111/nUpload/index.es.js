...
var index_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => ".upload-main[data-v-1c1cf07b]{position:relative;display:flex;justify-content:center;align-items:center;width:100px;height:100px;border:1px dashed #ccc;border-radius:4px;overflow:hidden;cursor:pointer}.upload-main .close-box[data-v-1c1cf07b]{position:absolute;top:2px;right:2px;width:22px;height:22px;display:flex;justify-content:center;align-items:center;background:rgba(0,0,0,.3);border-radius:50%;border:1px solid #cccccc}\n")();
...
var NUpload = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1c1cf07b"]]);
var index = {
  install(app) {
