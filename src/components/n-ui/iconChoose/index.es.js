import { openBlock, createElementBlock, createElementVNode, createStaticVNode, defineComponent, resolveComponent, createVNode, normalizeProps, guardReactiveProps, withCtx, createBlock, resolveDynamicComponent, resolveDirective, Fragment, renderList, unref, withDirectives, toDisplayString, createTextVNode } from "vue";
...
var index = {
  install(app) {
    app.component("IconChoose", _sfc_main);
  }
};
